...
import com.example.dnevnjak.data.db.converters.LocalDateTimeConverter
...
@Database(
    ...
    version = 1,
    exportSchema = false)
@TypeConverters(LocalDateConverter::class, LocalDateTimeConverter::class, StringListConverter::class)

...
public class Constants {
    // sharedPreferences
    public static final String SHARED_PREFERENCE_NAME = "com.example.constants";
    public static final String IS_LOGGED_KEY = "login_key";
    ...
    // bundle keys
    public static final String POPULATE_FIELDS_KEY = "populate_fields_key";
